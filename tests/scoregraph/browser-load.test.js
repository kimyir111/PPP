...
const ORDER = ['rational', 'schema', 'pitch', 'time', 'serialize', 'validate', 'build', 'prov', 'ops', 'xml',
  'musicxml-import', 'musicxml-export', 'midi-file', 'midi-import', 'legacy-score', 'import', 'meter-grid',
  'pro-critic', 'pro-staff', 'pro-voice', 'pro-rhythm', 'pro-tuplet', 'pro-spell', 'pro-beam', 'pro-marks', 'pro', 'index'];
