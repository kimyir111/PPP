...
| Active | **MX-1** (8va and pedal `change` playback) — review NEEDS_FIX, Fixer running; **G4c** (beams, tuplets, voices, rests, grace notes, `svg.js`) — in independent review (§14). |
