...
implemented and handed to the Lead as READY_FOR_REVIEW** (branch `g4e-print`, `D:/PPP-g4`, G04 §39, DECISIONS G4-E1–E7):
...
(`engr/6`, version-only re-bless). Not yet independently reviewed or merged.
