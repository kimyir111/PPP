...
- **Active goal: G4 Professional Engraving — G4a, G4b, G4c, G4d-1a and G4d-1b CLOSED (PR #9 `df8a571`, PR #12 `62ede61`,
  ...
  - **G4d-2** — worktree `D:/PPP-g4`, branch `g4d2-page-integration` from `main`: the renderer in the page behind a dev-only
    ...
    fallback to legacy with a counter, `agree.ok` required, and the M-H1 review tool (G04 §16, §22.4; roadmap §14).
