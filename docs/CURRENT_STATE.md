...
- **Active goal: G4 Professional Engraving — G4a, G4b, G4c, G4d-1a and G4d-1b CLOSED (PR #9 `df8a571`, PR #12 `62ede61`,
  ...
  - **G4d-2 — READY_FOR_REVIEW** (worktree `D:/PPP-g4`, branch `g4d2-page-integration`, pushed; no PR; G04 §37, DECISIONS
    G4-D2-1–18): the engraver draws in the real page behind a developer's switch (`?renderer=engrave` or localStorage
