...
attached to systems, vertical spacing, courtesy signs) is **READY_FOR_REVIEW** on branch `g4d1b-system-marks` (G04 §36,
DECISIONS G4-D1b-1–16), not merged. Read this first in a new session, then
...
- **Active goal: G4 Professional Engraving — G4a, G4b, G4c and G4d-1a CLOSED (PR #9 `df8a571`, PR #12 `62ede61`, PR #15
  `e3c8c5a`, PR #17 `b4fe019`); G4d-1b READY_FOR_REVIEW; next its review, then G4d-2.** The order, gates and briefs are in `docs/PPP_MASTER_ROADMAP.md` (§14 current task, §15 next).
  ...
  - **G4d-1b — READY_FOR_REVIEW** — worktree `D:/PPP-g4`, branch `g4d1b-system-marks` (code `17a38f3`, pushed, no PR):
    G04 §10.2 rows 7–11 (lyrics, dynamics, hairpins, pedal, ottava, volta, chord names, tempo, rehearsal, jumps, words),
    §15.3 vertical spacing, §15.4 courtesy signs, B9 re-measured (0.32), the G4d-1a review's R5 (G04 §36). The Lead arranges
    the independent review; E17 and E18 are unchanged (MX-1's tests hold them), the break cases are in E37.
