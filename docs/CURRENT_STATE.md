...
sees. **Next: G4d-1a** (curves and marks attached to notes; G4-L3). Read this first in a new session, then
...
- **Active goal: G4 Professional Engraving — G4a, G4b and G4c CLOSED (PR #9 `df8a571`, PR #12 `62ede61`, PR #15
  ...
  - **G4d-1a** — worktree `D:/PPP-g4`, branch `g4d1a-curves-marks` from `main`: G04 §13 ties, slurs and glissando, `place()`
    over skylines, the marks attached to notes (articulations, ornaments, fermata, fingering, arpeggio, noteheads), the
    §18.3 text-metrics table, and the G4c review's note-level carry-overs (G4-L3; roadmap §14).
