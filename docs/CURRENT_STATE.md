...
Updated 2026-09-25 (G4a merged as PR #9; `main` as below). G0 (Quality Foundation), G1 (ScoreGraph) and G2 (Score Import) are all merged
...
renderer is still the one drawing (16/16 renders byte-identical to `55d1bd5`). **G4b (layout core) is next and has not
started**: worktree `D:/PPP-g4`, branch `g4b-layout-core` from the latest `main`. Read this first
