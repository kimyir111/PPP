...
## 48. G4 폴리싱 — H03 조사: sonatina/019, 11–18마디 (2026-09-27)

### 48.1 배경

§42.2: 빽빽한 기호(소나티네) 층에서 legacy가 "전체" 점수로 이긴 두 발췌(H01·H03) 중, H01은 §42.1·§46(다른 트리)에서 조사되어 결함 아님으로 닫혔다. **H03(sonatina/019, 11–18마디)은 양쪽 다 지적된 발췌라 flip 결정을 막지 않았지만, 실제로 들여다본 적이 없었다.** 사용자 코멘트 — engrave: "이어지는 선이 왜 두겹씩 있고 13 마디 음표는 또 왜 선이 이상하냐"; legacy: "16번쨰 선 이어진거만 좀 이상함 그리고 17~18마디 사이 음 배치 간격과 박자 이상해보여". 이 절은 그 조사 기록이다.
